  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full overflow-hidden pt-8 pb-16 lg:pt-12 lg:pb-24">
        ...
        {/* Conteúdo Principal */}
        <div className="container mx-auto h-full flex flex-col lg:flex-row items-center px-6 relative pt-8 lg:pt-16">
          ...
          <div className="w-full lg:w-1/2 order-2 lg:order-1 mt-12 lg:mt-0">
            <div className="max-w-2xl mx-auto lg:mx-0 text-center lg:text-left">
              ...
              <motion.h1
                ...
                className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-8 leading-tight text-[#191919]"
              >
              ...
              <motion.p
                ...
                className="text-lg text-[#191919]/80 mb-12 leading-relaxed"
              >
              ...
              >
                <div className="flex flex-col items-center lg:items-start">
                  <span className="text-3xl font-bold text-[#ff914d]">500+</span>
                  <span className="text-sm text-[#191919]/70">Eventos realizados</span>
                </div>
                <div className="flex flex-col items-center lg:items-start">
                  <span className="text-3xl font-bold text-[#ff914d]">20K+</span>
                  <span className="text-sm text-[#191919]/70">Participantes</span>
                </div>
                <div className="flex flex-col items-center lg:items-start">
                  <span className="text-3xl font-bold text-[#ff914d]">50+</span>
              ...
              >
                <Link to="/criar-conta">
                  <Button className="bg-[#ff914d] hover:bg-[#ff7b33] text-white font-bold px-8 py-6 text-lg shadow-lg shadow-[#ff914d]/20 hover:shadow-[#ff914d]/40 transition-all duration-300">
                    Começar Agora
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </Button>
                </Link>

                <Link to="/explorar-eventos">
                  <Button
                    variant="outline"
                    className="border-[#ff914d] text-[#ff914d] hover:bg-[#ff914d]/10 hover:text-[#ff7b33] font-medium px-8 py-6 text-lg transition-all"
                  >
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2 flex items-center justify-center lg:justify-end">
            ...
            >
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100 transform rotate-1">
                <div className="bg-[#ff914d] text-white text-xs font-bold px-4 py-2 rounded-full inline-block mb-6">
                  EM BREVE
                </div>
                
                <h3 className="text-2xl font-bold text-[#191919] mb-4">Workshop de Inovação Acadêmica</h3>
                
                <div className="flex items-center text-sm text-[#191919]/70 mb-4">
                  <Calendar className="h-5 w-5 mr-2 text-[#ff914d]" />
                ...
                <div className="flex justify-between items-center mb-6">
                  ...
                  <div className="text-[#ff914d] font-bold text-lg">Grátis</div>
                </div>
                
                <Button className="w-full bg-[#ff914d] hover:bg-[#ff7b33] text-white py-6 text-base">
